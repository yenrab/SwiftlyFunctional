...
//  SwiftlyFunc
//
//  Created by Lee Barney on 10/27/15.
...
/*
* The purpose of SwiftlyFunc is to allow developers to begin coding their
* app functionally without having to deal with so much OO. MVC is an OO
* pattern and doesn't necissarily fit as a functional design pattern. It
* could, if rethought.
*
* To do's:
* 1) hide AppDelegate and ViewController.
* 2) create functions that map closures to app eve
@IBOutlet weak var theButton: UIButton!
nts
* 3) abandon the ViewController class. Map UI elements to closures. Create
* a single IBAction for for all touchable UIElements. Back it with an 'app
* controller' like functionality mapping the element's identifier with
* a closure.
*/
